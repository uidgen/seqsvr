...
#ifndef	STORESVR_STORE_SERVICE_IMPL_H_
#define	STORESVR_STORE_SERVICE_IMPL_H_

#include "storesvr/zrpc_store_service.h"

class StoreServiceImpl : public ZRpcStoreService {
public:
  virtual ~StoreServiceImpl() = default;
